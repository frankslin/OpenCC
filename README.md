...
* `t2cngov.json` **Traditional Chinese (OpenCC Standard)** to **CN Government Standard** / **OpenCC 標準繁體** 到 **大陸政府標準繁體**
* `t2cngov_keep_simp.json` **Traditional Chinese (OpenCC Standard)** to **CN Government Standard (Keep Simplified)** / **OpenCC 標準繁體** 到 **大陸政府標準繁體（保留簡體）**
