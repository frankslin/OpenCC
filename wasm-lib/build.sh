...
OPENCC_SRCS=(
  ...
  ${OPENCC_SRC_DIR}/src/ConversionAmbiguities.cpp
...
INCLUDE_FLAGS=(
  ...
  -I${OPENCC_SRC_DIR}/deps/darts-clone-0.32h/include
)
...
COMMON_FLAGS=(
  ...
  -s EXPORTED_FUNCTIONS="['_opencc_create','_opencc_convert','_opencc_inspect','_opencc_convert_candidates','_opencc_convert_with_ambiguities','_opencc_destroy','_malloc','_free']"
